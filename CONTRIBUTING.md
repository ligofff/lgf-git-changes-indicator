...
1. Make an [Issue](https://github.com/ligofff/lgf-git-changes-indicator/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-git-changes-indicator": "https://github.com/YOUR_USER/lgf-git-changes-indicator.git"
        }
    }
```
